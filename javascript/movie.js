let movieEvents = "http://soperfect.dk/kea/07-cms/wp00/wp-json/wp/v2/movies?_embed";
let page = 1;
...
function fetchEvents() {
    ...
    if (catid) {
        movieEvents = "http://soperfect.dk/kea/07-cms/wp00/wp-json/wp/v2/movies?_embed&per_page=10&page=" + page + "&categories=" + catid;
    }
...
function showSingleMovieEvent(movie) {
    ...
    movieClone.querySelector(".movie-date").textContent = movie.acf.date;
